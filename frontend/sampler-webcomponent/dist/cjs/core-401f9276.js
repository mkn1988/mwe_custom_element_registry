...
const NAMESPACE = 'sampler-component';
...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-401f9276.js', document.baseURI).href));
